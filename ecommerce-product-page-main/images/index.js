...
function imageSwitch() {
  if (index === 0) {
    collections.style.content = "url(image-product-1.jpg)"

  } else if (index === 1) {
    collections.style.content = "url(image-product-2.jpg)"

  } else if (index === 2) {
    collections.style.content = "url(image-product-3.jpg)"

  } else if (index === 3) {
    collections.style.content = "url(image-product-4.jpg)"
  }
}
...
addToCart.addEventListener("click", function() {
  if (parseInt(quantity.textContent) > 0) {
    ...
    amount.textContent = `$${quantity.textContent * 125}`
...
function zImageSwitch() {
  if (index === 0) {
    zCollections.style.content = "url(image-product-1.jpg)"
  } else if (index === 1) {
    zCollections.style.content = "url(image-product-2.jpg)"
  } else if (index === 2) {
    zCollections.style.content = "url(image-product-3.jpg)"
  } else if (index === 3) {
    zCollections.style.content = "url(image-product-4.jpg)"
  }
}
